...
public class RecyclerHelper extends HelperBase {
    ...
    public void swipeFromRigthToLeft() {
    ...
    public void swipeFromLeftToRigth() {
        List<MobileElement> list =
                driver.findElements(By.id("com.h6ah4i.android.example.advrecyclerview:id/container"));
        MobileElement el = list.get(0);
        System.out.println(driver.manage().window().getSize().getWidth());
    ...
    public void dragDown() {
        ...
        TouchAction<?> touchAction = new TouchAction<>(driver);
        touchAction.longPress(PointOption.point(xfrom,yfrom))
                .moveTo(PointOption.point(xto,yfrom+ rect.getHeight()))
                .release()
                .perform();
    ...
    public void dragDownCount(int count) {
        ...
        TouchAction<?> touchAction = new TouchAction<>(driver);
        touchAction.longPress(PointOption.point(xfrom,yfrom))
                .moveTo(PointOption.point(xto,yfrom+ rect.getHeight()*count))
                .release()
                .perform();
    ...
    public void dragDownWin() {
        ...
        TouchAction<?> touchAction = new TouchAction<>(driver);
        touchAction.longPress(PointOption.point(xfrom,yfrom))
                .moveTo(PointOption.point(xto,heightWin-rect.getHeight()/2))
                .release()
                .perform();
